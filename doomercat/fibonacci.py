...
def fibonacci_lattice_batch(D: float,
    ...
    a : float, optional
        ...
        Default is the WGS84 radius in kilometer, a = 6378.137 km.
...
try:
    ...
    def fibonacci_lattice(D: float,
        ...
        # parameters of model to relate number of points to average distance
        # on the sphere with radius "a_earth"
        p = np.array([ 1.06113340e+00,  1.81909121e-04,  6.87745830e-01,
            2.73178890e-02,  1.80008060e+00,  1.31022975e+01, -2.89844396e+00])
